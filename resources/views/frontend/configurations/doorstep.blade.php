    ...
    <div class="row">
        ...
        <div class="col-md-9 text-center">
            <ul class="steps">
                ...
                <li>4</li>
                <li>5</li>
                <li style="background: #ec4530"><b>6</b></li>
                <li>7</li>
                <li>8</li>
                <li>9</li>
                <li>10</li>
            ...
            <h3>@lang('translations.doorstep_choice'):</h3>

            <hr>


            <form action="{{route('classic_config_doorstep_store')}}" method="post">
                {{csrf_field()}}
                ...
                @foreach($doorsteps as $doorstep)
                    <div class="col-sm-6 col-md-6">
                        <div class="thumbnail" style="border: solid thin #fd856e; border-radius: 15px;">
                            <img src="{{url($doorstep->image_path)}}" alt="" style="max-height: 150px">
                            <div class="caption">
                                <input id="{{$doorstep->id}}" type="radio" name="doorstep" value="{{$doorstep->id}}" required> <label for="{{$doorstep->id}}">@if($language == 'sr'){{$doorstep->name}} ( @elseif($language == 'en') {{$doorstep->name_en}}( @endif  {{$doorstep->price}} EUR )</label>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div id="current_config" class="col-md-3 text-left" style="background-color: #fdf0d1;">
            ...
            <ul>
                ...
                <li>@if($language == 'sr'){{$config2->hinge->name}} @elseif($language == 'en'){{$config2->hinge->name_en}} @endif</li>
            </ul>
